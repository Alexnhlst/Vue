...
<script>
// mapGetters is an helper function that directly sore getters with component computed properties
// it helps avoid the continous reference of this.$store.getters
import { mapGetters } from "vuex"
import ProductListItem from './ProductListItem'
export default {
    name: 'ProductList',
    computed: {
        // we use the object spread operator to directly "copy" the getters into the components computed property
        ...mapGetters([
            "productItems"
        ])
    },
