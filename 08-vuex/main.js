const InputForm = {
  // with Vuex form binding involves binding the value of the input to the data property
  // listening for any changes in the input
  // and invoking an action/mutation when a change is made
  template: `
